...
entry:
  ...
  %tmp10 = load ptr, ptr %tmp2, align 8
  call void @arraylist_add_int(ptr %tmp10, i32 %a)
  %tmp18 = load ptr, ptr %tmp2, align 8
  call void @arraylist_add_int(ptr %tmp18, i32 %b)
  %tmp26 = load ptr, ptr %tmp2, align 8
  call void @arraylist_add_int(ptr %tmp26, i32 %c)
  %tmp30 = load ptr, ptr %s, align 8
  call void @arraylist_add_ptr(ptr %tmp30, ptr %tmp2)
  ret ptr %s
...
entry:
  ...
  %tmp89 = call ptr @arraylist_get_ptr(ptr %tmp86, i64 0)
  %tmp947 = load ptr, ptr %s, align 8
  %tmp968 = call i32 @length(ptr %tmp947)
  %tmp979 = icmp slt i32 0, %tmp968
  br i1 %tmp979, label %while_body_7.lr.ph, label %while_end_8

while_body_7.lr.ph:                               ; preds = %entry
  br label %while_body_7

while_body_7:                                     ; preds = %while_body_7.lr.ph, %while_end_11
  %i_1.011 = phi i32 [ 0, %while_body_7.lr.ph ], [ %tmp132, %while_end_11 ]
  %total.010 = phi i32 [ 0, %while_body_7.lr.ph ], [ %total.1.lcssa, %while_end_11 ]
  %r_3 = alloca ptr, align 8
  %tmp100 = load ptr, ptr %s, align 8
  %tmp102 = zext i32 %i_1.011 to i64
  %tmp103 = call ptr @arraylist_get_ptr(ptr %tmp100, i64 %tmp102)
  store ptr %tmp103, ptr %r_3, align 8
  %j_1 = alloca i32, align 4
  store i32 0, ptr %j_1, align 4
  %tmp1061 = load i32, ptr %j_1, align 4
  %tmp1102 = load ptr, ptr %r_3, align 8
  %tmp1123 = load ptr, ptr %tmp1102, align 8
  %tmp1134 = call i32 @arraylist_size_int(ptr %tmp1123)
  %tmp1145 = icmp slt i32 %tmp1061, %tmp1134
  br i1 %tmp1145, label %while_body_10.lr.ph, label %while_end_11

while_body_10.lr.ph:                              ; preds = %while_body_7
  br label %while_body_10

while_body_10:                                    ; preds = %while_body_10.lr.ph, %while_body_10
  %total.16 = phi i32 [ %total.010, %while_body_10.lr.ph ], [ %tmp127, %while_body_10 ]
  %tmp119 = load ptr, ptr %r_3, align 8
  %tmp121 = load ptr, ptr %tmp119, align 8
  %tmp122 = load i32, ptr %j_1, align 4
  %tmp123 = zext i32 %tmp122 to i64
  %tmp124 = alloca i32, align 4
  %tmp125 = call i32 @arraylist_get_int(ptr %tmp121, i64 %tmp123, ptr %tmp124)
  %tmp126 = load i32, ptr %tmp124, align 4
  %tmp127 = add i32 %tmp126, %total.16
  %tmp128 = load i32, ptr %j_1, align 4
  %tmp130 = add i32 %tmp128, 1
  store i32 %tmp130, ptr %j_1, align 4
  %tmp106 = load i32, ptr %j_1, align 4
  %tmp110 = load ptr, ptr %r_3, align 8
  %tmp112 = load ptr, ptr %tmp110, align 8
  %tmp113 = call i32 @arraylist_size_int(ptr %tmp112)
  %tmp114 = icmp slt i32 %tmp106, %tmp113
  br i1 %tmp114, label %while_body_10, label %while_cond_9.while_end_11_crit_edge

while_cond_9.while_end_11_crit_edge:              ; preds = %while_body_10
  %split = phi i32 [ %tmp127, %while_body_10 ]
...
while_end_11:                                     ; preds = %while_cond_9.while_end_11_crit_edge, %while_body_7
  ...
  %tmp132 = add i32 %i_1.011, 1
  %tmp94 = load ptr, ptr %s, align 8
  %tmp96 = call i32 @length(ptr %tmp94)
  %tmp97 = icmp slt i32 %tmp132, %tmp96
  br i1 %tmp97, label %while_body_7, label %while_cond_6.while_end_8_crit_edge
...
define i32 @main() {
  %tmp134 = call ptr @malloc(i64 8)
  %tmp136 = call ptr @arraylist_create(i64 10)
  store ptr %tmp136, ptr %tmp134, align 8
  %tmp143 = call ptr @Matrix_adRow(ptr %tmp134, i32 1, i32 2, i32 3)
  %tmp148 = call ptr @Matrix_adRow(ptr %tmp134, i32 4, i32 5, i32 6)
  %tmp153 = call ptr @Matrix_adRow(ptr %tmp134, i32 7, i32 8, i32 9)
  %1 = call i32 (ptr, ...) @printf(ptr @.strStr, ptr @.str1)
  %tmp156 = call ptr @Matrix_printMatrix(ptr %tmp134)
  %2 = call i32 (ptr, ...) @printf(ptr @.strStr, ptr @.str2)
  %tmp161 = call ptr @Matrix_sum(ptr %tmp134)
  call void @print_Matrix(ptr %tmp161)
  %3 = call i32 @getchar()
  ret i32 0
}
