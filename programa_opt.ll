...
define i32 @main() {
  ...
  %t177 = call double @math_div(double 1.000000e+01, i32 0)
  %10 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.strDouble, double %t177)
  %puts1 = call i32 @puts(ptr nonnull dereferenceable(1) @.str5)
  %t180 = call i32 @math_factorial(i32 -3)
  %11 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.strInt, i32 %t180)
  %puts2 = call i32 @puts(ptr nonnull dereferenceable(1) @.str6)
  %t183 = call double @math_sqrt(i32 -9)
  %12 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.strDouble, double %t183)
