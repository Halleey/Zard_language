...
@.str0 = private constant [9 x i8] c"testando\00"
...
define ptr @Set_int_adicionar(ptr %s, i32 %value) {
entry:
...
entry:
  %tmp36 = load ptr, ptr %s, align 8
  %tmp38 = zext i32 %index to i64
  call void @arraylist_remove_int(ptr %tmp36, i64 %tmp38)
  ret ptr %s
...
define i32 @main() {
  %tmp40 = alloca %Set_int, align 8
  %tmp41 = call ptr @arraylist_create_int(i64 10)
  store ptr %tmp41, ptr %tmp40, align 8
  %tmp45 = call ptr @Set_int_adicionar(ptr %tmp40, i32 1)
  %tmp46 = call ptr @arraylist_create(i64 4)
  %tmp49 = call ptr @createString(ptr @.str0)
  call void @arraylist_add_String(ptr %tmp46, ptr %tmp49)
  call void @arraylist_print_string(ptr %tmp46)
  call void @print_Set_int(ptr %tmp40)
  call void @freeList(ptr %tmp46)
  %1 = call i32 @getchar()
  ret i32 0
}
