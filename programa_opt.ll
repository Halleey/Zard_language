...
while_end_2:                                      ; preds = %while_cond_0.while_end_2_crit_edge, %entry
  ...
  call void @arraylist_add_ptr(ptr %tmp10.lcssa, ptr %value)
  ret ptr %s
...
define i32 @main() {
  ...
  call void @Set_int_add(ptr %tmp2, i32 3)
  call void @Set_int_add(ptr %tmp2, i32 3)
  call void @print_Set_int(ptr %tmp2)
  %tmp14 = call ptr @malloc(i64 8)
  %tmp17 = call ptr @arraylist_create(i64 10)
  store ptr %tmp17, ptr %tmp14, align 8
  call void @Set_boolean_add(ptr %tmp14, i1 true)
  call void @Set_boolean_add(ptr %tmp14, i1 false)
  call void @Set_boolean_add(ptr %tmp14, i1 true)
  call void @print_Set_boolean(ptr %tmp14)
  %tmp28 = call ptr @malloc(i64 8)
  %tmp31 = call ptr @arraylist_create(i64 10)
  store ptr %tmp31, ptr %tmp28, align 8
  %tmp35 = call ptr @createString(ptr @.str0)
  call void @Set_string_add(ptr %tmp28, ptr %tmp35)
  %tmp38 = call ptr @createString(ptr @.str0)
  call void @Set_string_add(ptr %tmp28, ptr %tmp38)
  call void @print_Set_string(ptr %tmp28)
  ret i32 0
}
