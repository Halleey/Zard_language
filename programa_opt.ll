...
define i32 @main() {
  ...
  %tmp1 = call ptr @arraylist_create_int(i64 4)
  %tmp2 = alloca i32, i64 1, align 4
  store i32 2, ptr %tmp2, align 4
  call void @arraylist_addAll_int(ptr %tmp1, ptr %tmp2, i64 1)
  store ptr %tmp1, ptr %tmp0, align 8
  %tmp8 = call ptr @Set_int_add(ptr %tmp0, i32 2)
