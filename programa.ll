...
;;VAL:%t24;;TYPE:i1
  br i1 %t24, label %while_body_4, label %while_end_5
while_body_4:
  %t25 = load i32, i32* %a
;;VAL:%t25;;TYPE:i32
...
;;VAL:%t27;;TYPE:i1
  ...
  br i1 %t27, label %then_0, label %endif_0
then_0:
  call i32 (i8*, ...) @printf(i8* getelementptr ([24 x i8], [24 x i8]* @.str2, i32 0, i32 0))
  br label %while_end_5
endif_0:
  %t28 = load i32, i32* %a
  call i32 (i8*, ...) @printf(i8* getelementptr ([4 x i8], [4 x i8]* @.strInt, i32 0, i32 0), i32 %t28)
  %t29 = load i32, i32* %a
;;VAL:%t29;;TYPE:i32
